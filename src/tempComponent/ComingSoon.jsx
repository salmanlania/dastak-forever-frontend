...
//                 <img src={logo} alt="Logo" className="mb-6 w-96 h-auto animate-stretch" />
...
//                             className="flex-1 p-4 rounded-lg border border-gray-200 focus:outline-none focus:border-blue-500 transition-colors"
//                         />
//                         <button className="px-8 py-4 bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-600 transition-colors">
//                             Notify Me
//                         </button>
//                     </div>
//                 </div>
